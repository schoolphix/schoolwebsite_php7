        ...
        <div class="row sidebar-page">
            ...
            <div class="col-md-9 page-content">
               ...
               <? callErrorMessage();?>
                ...
                <!-- Classic Heading -->
                <h4 class="classic-title"><span>Upload Carousel Picture</span>
                	<span style="float:right">
                		<a href="carousel-list.php"><b>Show All Carousel Pictures</b></a>
                    </span>
                </h4>
...
<table width="100%" border="0" class="mytable" align="center" style="border-top:none">
  ...
  <tr>
    <td align="left" width="25%"><span style="font-weight:bold">Caption:</span></td>
    <td align="left">
		<textarea name="caption" title="enter carousel caption" rows="1" cols="50"></textarea>
    </td>
 </tr>
...
<input type="checkbox" style="cursor:pointer" name="remember" onClick="" id="check_resize"/>
  ...
  <tr>
  	<td>&nbsp;</td>
    <td align="left">
    <input type="hidden" name="action" value="upload-carousel" />
    ...
    <span style="color:#00f;font-weight:bold">Recommended Dimensions; 1440 x 500 pixels. PNG or JPG (1MB Max)</span>    
