	...
	<div class="container">
		...
		<div class="row">
			...
			<?php
				...
				if (!$result) {
				echo "<div class='portlet-msg-alert'>Fill all empty fields and ENSURE YOU ATTACH/UPLOAD CV by clicking 'Choose File' </div>";
				}
            ...
            ?> 				             
				...
				&nbsp <span style="color:#00f;font-weight:bold">PDF or MSword (5MB Max)</span> 
                </div>
                </div>
            ...
            <? }else{?>
    			<div class="portlet-msg-alert">Fill all empty fields and ENSURE YOU ATTACH/UPLOAD CV by clicking 'Choose File'</div>
    		<? }?> 
			</div>
<?	getSideBar($links)?> 
