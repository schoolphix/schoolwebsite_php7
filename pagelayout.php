...
?>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                  Powered By <a href="http://schoolphix.com/" target="_blank">Schoolphix Portal</a>
                  <br/>
                  <a href="login">Admin</a>&nbsp;|&nbsp;<a href="<?=$web_data['School_Website']?>/webmail" target="_blank">WebMail</a>
                </div>
            </div>
        </div>
    </footer>
